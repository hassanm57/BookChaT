...
const PLACEHOLDERS = [
  ...
  'Why does Winston Smith keep a diary if he knows it\'s dangerous?',
  'What is the last line of One Hundred Years of Solitude?',
  'How does Nabokov hide clues about Humbert\'s unreliability?',
  ...
  'Explain Catch-22 in Yossarian\'s own words.',
  'Who actually killed Bob Ewell, and why does it matter?',
  'What does Sethe\'s scar look like, and what does Beloved call it?',
  'Find every metaphor Sylvia Plath uses for the bell jar.',
  'What did Don Quixote mistake for giants?',
  'How does the opening line of Anna Karenina apply to the whole novel?',
  'What does Prufrock mean by "I have measured out my life with coffee spoons"?',
  'Trace every lie Gatsby tells Nick throughout the book.',
  'What is the significance of the chess game in The Seventh Seal?',
  'Find the passage where Edmond Dantès decides to become the Count.',
]
